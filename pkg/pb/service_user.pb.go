...
const file_service_user_proto_rawDesc = "" +
	"\n" +
	"\x12service_user.proto\x12\x02pb\x1a\x15rpc_create_user.proto2L\n" +
	"\vUserService\x12=\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"\x00B-Z+github.com/brmcode/user-auth-service/pkg/pbb\x06proto3"
