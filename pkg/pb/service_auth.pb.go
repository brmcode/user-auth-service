...
const file_service_auth_proto_rawDesc = "" +
	"\n" +
	"\x12service_auth.proto\x12\x02pb\x1a\x14rpc_login_user.proto2I\n" +
	"\vAuthService\x12:\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\x00B-Z+github.com/brmcode/user-auth-service/pkg/pbb\x06proto3"
