...
func (x *LoginUserRequest) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"user.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"X\n" +
	...
	"\x18refresh_token_expires_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAtB-Z+github.com/brmcode/user-auth-service/pkg/pbb\x06proto3"
